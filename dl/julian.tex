...
\usepackage{pifont} % Floron \ding{166} (Dedicatoria)
...
\usepackage[enum,lineno]{tabfigures} % Mejora los números en toc, items y lineno
% opciones: toc,enum,lineno. toc produce números espaciados. No lucen bien en Índice.
...
\hypersetup{
pdfcopyright={© 2022 José Julián González Osorno. Todos los derechos reservados.},
}
...
\addcontentsline{toc}{chapter}{\scshape Portada}
...
\pagestyle{empty}
\protect\phantomsection
\addcontentsline{toc}{chapter}{\scshape Dedicatoria}
...
\addcontentsline{toc}{chapter}{\scshape Agradecimientos}
...
\fancyfoot{}
\renewcommand{\headrulewidth}{0pt}
%\pdfbookmark{Índice}{indice}
\microtypesetup{protrusion=false}
\protect\phantomsection
\addtocontents{toc}{\vspace{\normalbaselineskip}}
\addcontentsline{toc}{chapter}{\scshape Índice}
\tableofcontents
...
\begin{figure}[H]
\centering
\pdfbookmark{Efrén Hernández (foto)}{eh-foto}
...
\pagestyle{empty}
\vspace*{42pt}
\pdfbookmark{Epígrafes (Dolores Castro y Juan Rulfo)}{epigraphs-castro-rulfo}
\begin{flushright}
\begin{minipage}{7.5cm}
...
La tesis se integra por tres apartados centrales. En el capítulo~\ref{ch:risa-vanguardia-y-cuento-hispanoamericano}, estudio la irrupción de la vanguardia y su estrecha relación con una risa de ruptura (\S~\ref{sec:manifestaciones-de-la-risa-vanguardista}, pág.~\pageref{sec:manifestaciones-de-la-risa-vanguardista}) que sacudió las estructuras del cuento, lo cual le imprimió una transformación al género, incluso en Latinoamérica, donde se aprecia claramente ese «escribir contra la literatura» que Rafael Lemus vio en Efrén Hernández.\footnote{Rafael Lemus, «Informe», en Alejandro Toledo (comp.), \emph{Dos escritores secretos. Ensayos sobre Efrén Hernández y Francisco Tario.} Consejo Nacional para la Cultura y las Artes\kernedslash Fondo Editorial Tierra Adentro, México, 2006, p. 42.} Además, analizo la recepción de la obra del escritor guanajuatense entre sus contemporáneos y estudiosos; exploro lo que ha dicho la crítica sobre su posible filiación con la vanguardia literaria hispanoamericana y las apreciaciones de varios autores respecto del humor en ella (\S~\ref{sec:un-escritor-de-vanguardia-u-original}, pág.~\pageref{sec:un-escritor-de-vanguardia-u-original}).

En el capítulo~\ref{ch:figuras-de-la-risa-en-la-cuentistica-de-hernandez} (pág.~\pageref{ch:figuras-de-la-risa-en-la-cuentistica-de-hernandez}) indago cómo la perspectiva narrativa de un hombre interior se enlaza al humor y a las constantes digresiones de sus narradores (\S~\ref{sec:sentidos-del-reir-lo-nimio}, pág.~\pageref{sec:sentidos-del-reir-lo-nimio}; \S~\ref{sec:el-humor-como-poetica-ficcional}, pág.~\pageref{sec:el-humor-como-poetica-ficcional} y \S~\ref{sec:la-divagacion-o-el-arte-de-correr-tras-el-tiempo}, pág.~\pageref{sec:la-divagacion-o-el-arte-de-correr-tras-el-tiempo}). Este hombre interior, el héroe que suele protagonizar ---y, la mayoría de las veces, narrar---, asume la investidura de algunas figuras clásicas de la risa como el distraído (\S~\ref{sec:el-distraido}, pág.~\pageref{sec:el-distraido}), el niño o el ingenuo (\S~\ref{sec:el-ingenuo-el-nino}, pág.~\pageref{sec:el-ingenuo-el-nino}), y el paria o marginado (\S~\ref{sec:el-marginado}, pág.~\pageref{sec:el-marginado}), una de cuyas representaciones es el escritor fracasado, variaciones estas del tonto, la figura de la risa por excelencia, como señaló Mijaíl Bajtín en su estudio sobre Rabelais,\footnote{Mijaíl Bajtín, \emph{La cultura popular en la Edad Media y en el Renacimiento. El contexto de Fran"cois Rabelais} (trad. de Julio Forcat y César Conroy). Alianza, Madrid, 1987.} y profundizó Luis Beltrán en \emph{Anatomía de la risa.}

Finalmente, en el capítulo~\ref{ch:tonos-y-giros-de-la-risa-hernandeana} (pág.~\pageref{ch:tonos-y-giros-de-la-risa-hernandeana}), exploro algunas formas que adopta la risa en esta cuentística: la relación entre el humor y lo cómico (\S~\ref{sec:el-humor-y-lo-comico}, pág.~\pageref{sec:el-humor-y-lo-comico}); la intertextualidad con la literatura de la risa y textos clásicos como la Biblia, a menudo desde un punto de vista paródico y desacralizador (\S~\ref{sec:intertextualidad-risa-parodia}, pág.~\pageref{sec:intertextualidad-risa-parodia}); el absurdo (\S~\ref{sec:absurdo}, pág.~\pageref{sec:absurdo}); el tono conversacional y humorístico hacia el lector (\S~\ref{sec:conversaciones-con-el-lector}, pág.~\pageref{sec:conversaciones-con-el-lector}), metanarrativo, donde se advierte la plena conciencia de su condición literaria (\S~\ref{sec:la-escritura-que-se-ve-a-si-misma}, pág.~\pageref{sec:la-escritura-que-se-ve-a-si-misma}). Debo apuntar que una parte preliminar de este apartado fue publicada en \emph{Mirar no es como ver. Ensayos críticos sobre la obra de Efrén Hernández} con el título de «Diálogos intertextuales en la cuentística de Efrén Hernández».
...
\pagestyle{empty}
\vspace*{42pt}
\pdfbookmark{Epígrafe (Rafael Lemus)}{epigraph-lemus}
\begin{flushright}
\begin{minipage}{7.5cm}
...
\pagestyle{empty}
\vspace*{42pt}
\pdfbookmark{Epígrafe (Efrén Hernández, Dos líneas sobre el cuento)}{epigraph-hernandez1}
\begin{flushright}
...
Por su combinación entre humorismo y sentido del absurdo, anota John Brushwood, Efrén guarda similitudes con Macedonio Fernández, en la medida en que ambos «expresan ideas serias, sobre el conflicto realidad\kernedslash* irrealidad y sobre las posibilidades expresivas, en un contexto siempre ameno, humorístico y frecuentemente absurdo».\footnote{John Brushwood, «Efrén Hernández y la innovación narrativa», en \emph{Nuevo Texto Crítico,} año \textsc{i}, núm.~1, (primer semestre, 1988), p. 87.} Un absurdo, como se lee en «Tachas», inherente a la realidad: «Lo natural sería, dice Gómez de la Serna, que los pajaritos dormidos se cayeran de los árboles. Y todos lo sabemos bien, aunque es absurdo, los pajaritos no se caen».\footnote{Efrén Hernández, \emph{Tachas} (epílogo de Salvador Novo). Secretaría de Educación Publica, México, 1928.} Para Brushwood, Efrén Hernández «proyecta una visión profunda del problema realidad\kernedslash irrealidad sin perder la \emph{habilidad de burlarse de sus propios pensamientos}».\footnote{Brushwood, art. cit., pp. 93--94. Cursivas mías.}
...
\pagestyle{empty}
\vspace*{42pt}
\pdfbookmark{Epígrafe (Efrén Hernández, Autos)}{epigraph-hernandez2}
\begin{flushright}
\begin{minipage}{7.5cm} % 7.5 cm (defecto)
...
Como vimos en la sección~\ref{sec:el-distraido} (pág.~\pageref{sec:el-distraido}) respecto del distraído, en «Un clavito en el aire» hay una asociación similar. El escritor no puede definir el tiempo porque un clavito, que flota en el aire, distrae siempre su atención, o sus profundas ideas se le escapan porque el aire le vuela el sombrero; también aquí las grandes cuestiones quedan disueltas por lo diminuto.
...
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\addtocontents{toc}{\vspace{\normalbaselineskip}} % Add space between Bibliography and Colophon
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Anatomía de la risa.} Ediciones Sin Nombre\kernedslash Consejo Nacional de Ciencia y Tecnología\kernedslash Universidad de Sonora, México, 2011. [Relámpago la risa; coord. Martha Elena Munguía Zatarain]\phantomsection\label{bib:beltran2011}
...
\begin{sloppypar}
\hangpara{1cm}{1}\textsc{Cándano Fierro}, Graciela, «Realismo grotesco y \emph{Exempla} medievales», \emph{Acta Poética,} vol. 20, núms. 1--2, (1999), pp. 91--117. [En línea]: \url{https://revistas-filologicas.unam.mx/acta-poetica/index.php/ap/article/download/29/28}
\end{sloppypar}
\phantomsection\label{bib:candano1999}
...
\hangpara{1cm}{1}\textsc{Cervantes}, Miguel de, \emph{Don Quijote de la Mancha} (ed. Francisco Rico). Instituto Cervantes\kernedslash Crítica, Barcelona, 1999.\phantomsection\label{bib:cervantes1999}
...
\hangpara{1cm}{1}\textsc{Franco Bagnouls}, Lourdes, «El caso de Efrén Hernández: coincidencia y disidencia de un poeta mexicano frente a la mística de los Siglos de Oro», en \textsc{Amezcua}, José; \textsc{Escalante}, Evodio \emph{et al.}, \emph{Homenaje a Margit Frenk.} Universidad Nacional Autónoma de México\kernedslash Universidad Autónoma Metropolitana, México, 1989, pp. 211--216.\phantomsection\label{bib:franco1989}

\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Bosquejos} (ed., pról., ns. e índices). Universidad Nacional Autónoma de México\kernedslash Instituto de Investigaciones Filológicas\kernedslash Centro de Estudios Literarios, México, 1995. [Nueva Biblioteca Mexicana]\phantomsection\label{bib:franco1995}
...
\hangpara{1cm}{1}\textsc{Hadatty Mora}, Yanna, \emph{Autofagia y narración. Estrategias de representación en la narrativa iberoamericana de vanguardia, 1922--1935.} Iberoamericana Vervuert, Madrid\kernedslash Frankfurt, 2003.\phantomsection\label{bib:hadatty2003}
...
\hangpara{1cm}{1}La Santa Biblia. Antiguo y Nuevo testamento (antigua versión de Casiodoro de Reina; revisada por Cipriano Valera). Sociedades Bíblicas Unidas, Corea, 2000.\phantomsection\label{bib:biblia2000}
...
\hangpara{1cm}{1}\textsc{Lemus}, Rafael, «Informe», en \textsc{Toledo}, Alejandro (comp.), \emph{Dos escritores secretos. Ensayos sobre Efrén Hernández y Francisco Tario.} Consejo Nacional para la Cultura y las Artes\kernedslash Fondo Editorial Tierra Adentro, México, núm. 117--118, 2006, pp. 38--69.\phantomsection\label{bib:lemus2006}
...
\hangpara{1cm}{1}\textsc{López Parada}, Esperanza, \emph{Una mirada al sesgo. Literatura hispanoamericana desde los márgenes.} Iberoamericana Vervuert, Madrid\kernedslash Frankfurt, 1999.\phantomsection\label{bib:lopezparada1999}
...
\hangpara{1cm}{1}\textsc{Minois}, George, \emph{Historia de la risa y la burla: del Renacimiento a nuestros días.} Universidad Veracruzana\kernedslash Ficticia\kernedslash Consejo Nacional de Ciencia y Tecnología, México, 2018.\phantomsection\label{bib:minois2018}
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{La risa en la literatura mexicana: apuntes de poética.} Iberoamericana Vervuert\kernedslash Bonilla Artigas, México, 2012.\phantomsection\label{bib:munguia2012}
...
\hangpara{1cm}{1}\textsc{Pascal}, Blaise, \emph{Pensamientos y otros escritos} (est. prelim. de R.~Guardini, F.~Mauriac, J. Mesner y Hans Küng). Porrúa, México, 2005, 3"a ed.\phantomsection\label{bib:pascal2005}
