...
\usepackage{eso-pic} % Cuadrícula. La opción "grid" agrega una cuadrícula.
...
\usepackage{float} % Mejora el posicionamiento de las imagenes
\usepackage{wrapfig} % Imágenes en el flujo del texto
\usepackage{transparent} % Agrega transparencia a las imagenes
...
\begin{center}
\textcalligra{\href{muxkernel@gmail.com}{Tuxkernel}}
\end{center}
\vfill
\end{document}
