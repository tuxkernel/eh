...
%\usepackage[quiet]{fontspec} % LUATEX
...
% TIPOGRAFÍA MINION PRO

%\usepackage[sups]{MinionPro}
%\useosf
%\useproportional

% TIPOGRAFÍA MINION3 (LUALATEX)

%\setmainfont{Minion3-Regular.otf}[
%ItalicFont        = Minion3-Italic.otf,
%BoldFont          = Minion3-Bold.otf,
%BoldItalicFont    = Minion3-BoldItalic.otf,
%SmallCapsFeatures = {Letters=SmallCaps},
%Numbers={OldStyle}
%]

% TIPOGRAFÍA CRONOS PRO

\usepackage[sups]{CronosPro} % PDFLATEX
\useosf
\useproportional
...
\usepackage{calligra} % Para los agradecimientos
%\usepackage{hologo} % Para el colofón.
...
%\usepackage[nosingleletter,homeoarchy,rivers,draft]{impnattypo} % Recomendaciones tipográficas. 

% Opciones: hyphenation (solo pdftex), parindent (solo pdftex), lastparline (solo pdftex), nosingleletter (solo luaTeX), homeoarchy (solo luaTeX), rivers (solo pdftex), frenchchapters (solo pdftex), draft. Si se activa esta opción con pdftex, produce errores con nosingleletter y homearchy. ¡No activar!

% En la tradición tipográfica francesa, la imprenta nacional recomienda:

% 1.- Eliminar la separación de palabras en dos líneas consecutivas.
% 2.- Sangrar la primera línea de un párrafo con un valor al menos de 1em.
% 3.- La última línea de un párrafo debe ser al menos igual (1em) o el doble (2em) del sangrado del siguiente párrafo.
% 4.- Eliminar palabras que empiezan y terminan igual (homeoarquías y homotéleutos).
% 5.- Eliminar ríos (rivers). 

% VIUDAS Y HUÉRFANAS

\usepackage[all]{nowidow} % Elimina viudas y huérfanas
%\usepackage[avoid-all]{widows-and-orphans} % Herramienta para viudas y huérfanas
%\usepackage{showhyphens} % Muestra patrones de silabación. Solo LuaTeX.
...
%\usepackage{pdfmarginpar} % Comentarios en archivos pdf
%\usepackage[useregional]{datetime2} % Agrega fecha y horario.

% ENCABEZADOS

\usepackage[compatV3]{fancyhdr} % Encabezados personalizados
...
%\fancyhead[RE,LO]{\small\sc agradecimientos}
...
\emph{Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén} era capaz de orientar rumbos literarios, encender palabras y pensamientos.}
\begin{flushright}
\textsc{Dolores Castro\index[nombres]{Castro, Dolores}}
\end{flushright}
\vspace*{28pt}
\emph{Efrén parecía un pajarito, pero con unas enormes tijeras de podar me fue quitando toda la hojarasca.}
\begin{flushright}
\textsc{Juan Rulfo\index[nombres]{Rulfo, Juan}}
\end{flushright}
\end{minipage}
\end{flushright}
% EFREN TACHAS
...
\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight]{eh1}} % \transparent{0.4}
}
\null\vfill
% INTRODUCCIÓN
...
\fancyhead[CO]{\small\sc introducción. aproximación a <<tachas>>} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{11}
...
Como cualquier lector inicial de Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén}, lo primero que conocí de él fue ese breve relato que aparece en diversas antologías del cuento mexicano del siglo \textsc{xx}: <<Tachas>> (1928). Muchos dicen que, al terminar de leerlo, se tiene la sensación de que se trata de un cuento pleno de inocencia y de fino humor, melancólico. No fui la excepción. Tras leer todos sus cuentos reafirmé la idea de estar ante una obra que se reía sutilmente, <<sin aristas hirientes>> como decía Alí Chumacero\index[nombres]{Chumacero, Alí}, de sus personajes, de la trama, del lector, del narrador y aun del autor. Una narrativa, como (de)mostraré en este trabajo, donde el humor es parte sustancial de su poética.

Sobre la vida de Efrén Hernández (León, Guanajuato\index[lugares]{Guanajuato!Leon@León}, 1904-Ciudad de México\index[lugares]{Mexico@México!Ciudad de}, 1958) se sabe que a los veintiún años intentó estudiar Derecho en la Escuela Nacional de Jurisprudencia de la Ciudad de México\index[lugares]{Mexico@México!Ciudad de}, quizá tratando de emular a su padre, quien fue juez en la Ciudad de Guanajuato\index[lugares]{Guanajuato!Ciudad de}. No obstante, solo cursó un año por parecerle <<vacío y sin meollo de sustancia verdadera lo que ahí se aprende>>.\footnote{Efrén Hernández, <<Ficha autobiográfica>>, en \emph{Obras} (pról. de Alí Chumacero; recopilación de textos de Miguel Capistrán\index[nombres]{Capistran@Capistrán, Miguel}, Alí Chumacero y Luis Mario Schneider; bibliografía de Luis Mario Schneider\index[nombres]{Schneider, Luis Mario}), México, Fondo de Cultura Económica, 1965, p. 3.} Creía que el conocimiento verdadero residía en <<los hombres de carne y hueso>>, en <<los libros buenos>> y en <<el mundo>>.\footnote{\emph{Idem.}}

Ese desdén hacia la vida universitaria se extendió, asimismo, a los padrinazgos políticos, académicos y culturales, y lo llevó a ejercer los más diversos trabajos para sobrevivir: vendió aretes de plástico, figuritas de yeso, lámparas, libros y productos de la Compañía Nacional de Subsistencias Populares (\textsc{conasupo}); fue archivista y electricista. Antes de llegar a la Ciudad de México\index[lugares]{Mexico@México!Ciudad de} había sido aprendiz de botica, de zapatero, de platero y dependiente en una tienda de ropa. Durante su etapa en la Ciudad de México\index[lugares]{Mexico@México!Ciudad de}, recuerda su hija Valentina Hernández Ponzanelli\index[nombres]{Hernandez@Hernández Ponzanelli, Valentina}, llegó incluso a hacerse pasar por <<Inspector de Salubridad>> en los puestos de comida solicitando una muestra para <<verificar>> su estado cuando el hambre arreciaba.\footnote{Esto me contó el poeta Fernando Rodríguez\index[nombres]{Rodriguez@Rodríguez, Fernando} antes de darme la entrevista donde refería que, en ciertas temporadas, Efrén Hernández vendía aretes de plástico, figuritas de yeso y lámparas para sobrevivir. Esta entrevista (más la de Dolores Castro\index[nombres]{Castro, Dolores} y Juan Bañuelos\index[nombres]{Banuelos@Bañuelos, Juan}) puede consultarse en José Julián González Osorno\index[nombres]{Gonzalez@González Osorno, José Julián}, <<Efrén Hernández a tres voces>>, \emph{Texto Crítico, Nueva Época}, año \textsc{xii}, núm. 24, enero-junio, 2009, pp. \mbox{139-145}; también en Juan M.\,Berdeja\index[nombres]{Berdeja Acevedo, Juan Manuel} y Julián Osorno\index[nombres]{Gonzalez@González Osorno, José Julián!Osorno, Julián}, \emph{Mirar no es como ver. Ensayos críticos sobre la obra de Efrén Hernández}, México, Universidad Autónoma de Querétaro, 2018, pp. 209-217.} Sus dos empleos mejor pagados fueron, quizá, el de oficinista en la Secretaría de Educación Pública (\textsc{sep}), junto a Juan Rulfo\index[nombres]{Rulfo, Juan}, y el de subdirector de la revista \emph{América}.

Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén} fue un atento lector de una amplia tradición literaria y filosófica, clásica y moderna.\footnote{Entre estos autores pueden citarse: Cervantes\index[nombres]{Cervantes Saavedra, Miguel de}, Santa Teresa\index[nombres]{Santa Teresa}, San Juan de la Cruz\index[nombres]{San Juan de la Cruz}, fray Luis de León\index[nombres]{Luis de León}, Quevedo\index[nombres]{Quevedo, Francisco de} y Góngora\index[nombres]{Gongora@Góngora, Luis de}; filósofos como Demócrito\index[nombres]{Democrito@Demócrito}, Sócrates\index[nombres]{Socrates@Sócrates}, Platón\index[nombres]{Platon@Platón}, Plotino\index[nombres]{Plotino}, Pascal\index[nombres]{Pascal, Blaise}, Nietzsche\index[nombres]{Nietzsche, Friedrich} y Heidegger\index[nombres]{Heidegger, Martin}. Además de don Juan Manuel\index[nombres]{Juan Manuel, don}, Shakespeare\index[nombres]{Shakespeare, William}, Giono\index[nombres]{Giono, Jean}, Gracián\index[nombres]{Gracian@Gracián, Baltasar}, Gómez de la Serna\index[nombres]{Gomez@Gómez de la Serna, Ramón}, Hamsun\index[nombres]{Hamsun, Knut} y Faulkner\index[nombres]{Faulkner, William}; y textos como \emph{El Panchatantra} y \emph{Las mil y una noches}. Cfr. Marco Antonio Millán\index[nombres]{Millan@Millán, Marco Antonio}, \emph{La invención de sí mismo} (ed. de Daniel González Dueñas\index[nombres]{Gonzalez@González Dueñas, Daniel} y Alejandro Toledo\index[nombres]{Toledo, Alejandro}), México, Consejo Nacional para la Cultura y las Artes, 2009, pp. 75 y 81; <<Efrén Hernández a tres voces>>, art. cit.; Federico S.~Inclán\index[nombres]{Inclan@Inclán, Federico S.}, <<Carta a un amigo ausente>>, \emph{América. Revista Antológica}, \emph{Época Nueva}, núm. 73, septiembre-octubre, 1959, p. 15.} Aunque breve, su obra abarca cuento, poesía,\footnote{Sus poemas están contenidos en los libros \emph{Hora de horas} (1936) y \emph{Entre apagados muros} (1943).} teatro,\footnote{Las obras de teatro son \emph{Adanijob (fragmento)} y \emph{Cederano}, rescatadas por Alejandro Toledo del archivo de Efrén Hernández y publicadas en el tomo \textsc{ii} de las \emph{Obras Completas} (2012).} novela,\footnote{Sus novelas son \emph{Cerrazón sobre Nicómaco. Ficción harto doliente} (1946); \emph{La paloma, el sótano y la torre} (1949); \emph{Abarca. Fragmento de novela} (1949) y \emph{Autos}, descubierta por Alejandro Toledo entre los papeles de Efrén Hernández y publicada en 2007 en el tomo \textsc{i} de las \emph{Obras Completas}.} crítica literaria\footnote{Los ensayos son los comentarios de Efrén acerca de obras de diversos autores, sobre todo mexicanos, contemporáneos a él. La mayoría recopilados por primera vez por Franco\index[nombres]{Franco Bagnouls, María de Lourdes} en \emph{Bosquejos} (1995). \emph{Videm} \hyperref[bib:franco1995]{Fuentes consultadas}.} y dos guiones para cine, uno para la actriz María Douglas\index[nombres]{Douglas, María} y otro para Cantinflas\index[nombres]{Cantinflas}.\footnote{Alejandro Toledo, <<El guión [\emph{sic}] que Cantinflas no pudo filmar>>, \emph{El Universal}, 7 de agosto, 2011; \emph{Obras \textsc{ii}}, Fondo de Cultura Económica, México, 2012, p. 5. \emph{Videm} <<El ``Tachas''\index[nombres]{Hernandez@Hernández, Efrén!\emph{Tachas}} [\emph{sic}] escribe un asunto para Cantinflas>>, \emph{Prensa Gráfica}. México, 21 de mayo, 1949; <<Cantinflas tiene a su alcance el argumentista que necesitaba>>,  \emph{Ovaciones}. México, 1 de febrero, 1950.} Considerados como obras de teatro en las \emph{Obras completas}, \emph{Casi sin rozar el mundo} (1956) fue escrito para María Douglas\index[nombres]{Douglas, María} y \emph{Dichas y desdichas de Nicócles Méndez; tragiburledia cinematográfica} (1951) para Cantinflas\index[nombres]{Cantinflas}, esta a petición de Andrés Serra Rojas\index[nombres]{Serra Rojas, Andrés}, entonces director del Banco Nacional Cinematográfico.

Se creía que \emph{Dichas y desdichas de Nicócles Méndez} había sido escrita junto con Dolores Castro\index[nombres]{Castro, Dolores}, Rosario Castellanos\index[nombres]{Castellanos, Rosario} y Marco Antonio Millán\index[nombres]{Millan@Millán, Marco Antonio}; de hecho, se publicó en la revista \emph{América} (núm. 65, abril, 1951) como obra colectiva. No obstante, Dolores Castro le aclaró después a Alejandro Toledo\index[nombres]{Toledo, Alejandro} <<la invitación a participar en ese proyecto fue un acto de generosidad con dos jóvenes ---ella y Rosario Castellanos--- que se iniciaban en el mundo de las letras y con Millán, que era su mejor amigo>>. El texto se puede acreditar <<casi enteramente a Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén}>>.\footnote{Toledo, loc. cit.} Y en efecto, quienes leyeron esta obra aseguraban que había nacido \emph{el verdadero guionista de Cantinflas}.
\section*{La revista \textit{América} y el descubrimiento de Juan Rulfo}\label{sec:La-revista-américa-y-el-descubrimiento-de-juan-rulfo}
\addcontentsline{toc}{section}{La revista \emph{América} y el descubrimiento de Juan Rulfo}
Efrén Hernández fue, asimismo, un editor generoso que descubrió e impulsó a otros escritores, como Juan Rulfo\index[nombres]{Rulfo, Juan}. De esto da fe su participación en la revista \emph{América}, a la que ayudó a consolidar dándole un enfoque más literario en su calidad de subdirector.\footnote{Cfr. Lourdes Franco Bagnouls\index[nombres]{Franco Bagnouls, María de Lourdes}, \emph{Bosquejos} (ed., pról., ns. e índices), México, Universidad Nacional Autónoma de México"/Instituto de Investigaciones Filológicas"/Centro de Estudios Literarios, 1995 [Nueva biblioteca mexicana].} Fundada por miembros de las Juventudes Socialistas Unificadas de México (los poetas Roberto Guzmán Araujo\index[nombres]{Guzman@Guzmán Araujo, Roberto}, Manuel Lerín\index[nombres]{Lerin@Lerín, Manuel} y el ensayista Agustín Rodríguez Ochoa\index[nombres]{Rodriguez@Rodríguez Ochoa, Agustín}) y por miembros de la Juventud Socialista Española,\footnote{Cfr. Elvira Acuña González\index[nombres]{Acuna@Acuña González, Elvira}, \emph{Índices de \emph{América}. Revista Antológica}, México, Universidad Iberoamericana, 2000, pp. 5-10 [Tesis de Licenciatura].} en sus primeros números Alfonso Reyes\index[nombres]{Reyes, Alfonso} figuró como miembro de su comité editorial. Efrén Hernández fue invitado en 1942 por Marco Antonio Millán, el entonces Director de la revista, para desempeñarse como editor. Al principio se negó porque le parecía un medio muy político. Finalmente aceptó. Sus primeras participaciones las rubricó como <<Till Ealing\index[nombres]{Hernandez@Hernández, Efrén!\emph{Till Ealing}}>>; meses después firmó ya con su nombre. Como subdirector, su presencia fue vital para promover a jóvenes escritores de México\index[lugares]{Mexico@México}.\footnote{Millán, \emph{op. cit.}, pp. 72-73.}

\emph{América} jugó un papel importante en la vida cultural de México\index[lugares]{Mexico@México} de 1940 a 1969, comparable quizá al que desempeñaron, también en la primera mitad del siglo
\textsc{xx}, \emph{Taller}, \emph{Contemporáneos}, \emph{Examen}, \emph{Letras de México}, \emph{El Hijo Pródigo}, \emph{Rueca}, \emph{Pan}, \emph{Dintel}, \emph{Espiral}, \emph{Fuensanta}, \emph{Metáfora}, \emph{Tiras de Colores} o \emph{Estaciones}. Su criterio editorial de apoyar a <<gente de letras nueva, valiosa, desconocida o subestimada>>\footnote{Rosario Castellanos\index[nombres]{Castellanos, Rosario} recuerda de la participación de Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén} en la revista: <<Durante el tiempo que tuvo a su cargo la dirección de \emph{América} abrió las puertas de par en par a quienes, sin más carta de recomendación que sus manuscritos, se acercaban en busca de un espacio en el cual divulgar [\emph{sic}] la buena nueva de sus creaciones literarias>>. Acuña González\index[nombres]{Acuna@Acuña González, Elvira}, \emph{op. cit.}, p. 20. \emph{Videm} Rosario Castellanos, \emph{Obras \textsc{ii}. Poesía, teatro y ensayo}, Fondo de Cultura Económica, México, 1998, p. 474.} fue un impulso en la difusión de la obra de, entonces, jóvenes escritores como Juan Rulfo\index[nombres]{Rulfo, Juan}, Jaime Sabines\index[nombres]{Sabines, Jaime}, Emilio Carballido\index[nombres]{Carballido, Emilio}, Edmundo Valadés\index[nombres]{Valades@Valadés, Edmundo}, Rosario Castellanos, Juan José Arreola\index[nombres]{Arreola, Juan José} y Dolores Castro\index[nombres]{Castro, Dolores}, entre otros. Sus miles de páginas, durante este periodo, mostraron parte de la poesía, la novela, el cuento, el teatro, el ensayo y la crítica de México y otros países latinoamericanos.

Sobre la importancia de esta revista en la promoción de jóvenes escritores, en 1993 Sergio López Mena\index[nombres]{Lopez@López Mena, Sergio} había señalado el impulso que esta publicación dio a las primeras creaciones de Rulfo y de otros importantes escritores, y el papel destacado que tuvo en ello Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén}.\footnote{Cfr. Sergio López Mena, \emph{Los caminos de la creación en Juan Rulfo}. México, Universidad Nacional Autónoma de México, 1993, pp. 59-71.} Algunos de estos escritores luego le expresarían su agradecimiento.

Rosario Castellanos, por ejemplo, le decía a Hernández en una carta de 1942, con timidez: <<siento por ustedes [Millán\index[nombres]{Millan@Millán, Marco Antonio} y él] una gratitud muy grande. Han sido tan cordiales, tan amables con nuestros balbuceos. Y recordando que usted es tan bueno y tan sencillo y sabiendo que yo jamás le diría estas cosas personalmente, me atreví a escribírselas>>.\footnote{En carta fechada en Tehuacán\index[lugares]{Tehuacan@Tehuacán}, Puebla\index[lugares]{Puebla}, el 25 de septiembre de 1948, Rosario Castellanos agradecía a Efrén Hernández el apoyo que él y Marco Antonio Millán le habían dado a ella y a Dolores Castro al publicar sus primeros escritos (\emph{Apuntes para una declaración de fe}, con nota introductoria de
Millán) en la revista \emph{América}, además comentaba acerca de sus lecturas y daba su opinión sobre el inicio de la novela \emph{Cerrazón sobre Nicómaco}. \emph{Videm} Samuel Gordon y Fernando Rodríguez (eds.), <<Cartas de Rosario Castellanos a Efrén Hernández>>, \emph{Literatura mexicana \textsc{vii}} (1), 1996, pp. 187-188.} Juan Rulfo\index[nombres]{Rulfo, Juan} comentó de él:
\begin{quoting}
en el archivo de Migración nada se movía porque a nadie le interesaba estar ahí. Con cada cambio de gabinete los corrían a todos, menos a los del archivo del cual ni se acordaban, y en ese departamento donde no sucedía nada nos fuimos a meter Jorge Ferretis\index[nombres]{Ferretis, Jorge} y yo, a la sombra de Efrén Hernández\index[nombres]{Hernandez@Hernández, Efrén}. No queríamos que nos viera nadie, para así dedicarnos a nuestras cosas>>.\footnote{Se ha comentado que Rulfo conoció a Efrén Hernández en 1935 en la Secretaría de Educación Pública o, quizá, en 1937, en Gobernación (Archivo de Migración), donde Hernández fungía como <<jefe>>; véase al respecto la entrevista de Elena Poniatowska\index[nombres]{Poniatowska, Elena} a Juan Rulfo en Roberto García Bonilla\index[nombres]{Garcia@García Bonilla, Roberto}, \emph{Un tiempo suspendido. Cronología de la vida y la obra de Juan Rulfo}. México, Consejo Nacional para la Cultura y las Artes, 2008, p. 92.}
\end{quoting}
...
\end{quoting}
Este impulso a Rulfo ha sido comparado incluso con el papel que desempeñó Max Brod\index[nombres]{Brod, Max} con la obra de Kafka\index[nombres]{Kafka, Franz}.\footnote{Tal como Max Brod hizo con Kafka, apunta Nuria Amat\index[nombres]{Amat, Nuria}, Hernández rescató a Rulfo del silencio, una generosidad con la palabra de otros escritores que parece hasta insólita en el ámbito literario: <<Lo que hizo en realidad Efrén fue potenciar el estilo personalísimo de su admirado amigo, limpiando ripios, limando retóricas, librándolo de verbosidad y barroquismo y contribuyendo como nadie a un gran salto en la carrera de escritor de Rulfo>>. Nuria Amat, \emph{Juan Rulfo, el arte del silencio}, Barcelona, Ediciones Omega, 2003, p. 101 [Vidas Literarias].} En todo caso, Hernández fue para Rulfo, recordaba Arreola\index[nombres]{Arreola, Juan José}, \emph{un alma necesaria y oportuna}.\footnote{Entrevista de Elena Poniatowska\index[nombres]{Poniatowska, Elena} \emph{apud} García Bonilla\index[nombres]{Garcia@García Bonilla, Roberto}, \emph{op. cit.}, p. 113.}
...
Cabe anotar que dos de estos cuentos, <<Nos han dado la tierra>> y <<Macario>>, no fueron publicados inicialmente en \emph{América}, pues aparecieron por primera vez en \emph{Pan. Revista de Literatura}, coordinada por Juan José Arreola y Antonio Alatorre\index[nombres]{Alatorre, Antonio}. No obstante, \emph{América} albergó estos siete cuentos antes de que aparecieran en el volumen \emph{El Llano en Llamas}, más el relato <<La vida no es muy seria en sus cosas>> (junio, 1945), que no fue incluido en dicho volumen.\footnote{Los cuentos de Rulfo publicados por primera vez en \emph{Pan} son: <<Nos han dado la tierra>>, núm. 2, julio, 1945, pp. 1-3 y <<Macario>>, núm. 6, noviembre, 1945, pp. 1-3. Los publicados por primera vez en \emph{América}: <<La vida no es muy seria en sus cosas>>, núm. 40, 30 de junio, 1945, pp. 35-36; <<Es que somos muy pobres>>, núm.~54, 30 de agosto, 1947, pp. 24-29; <<La Cuesta de las Comadres>>, núm. 55, 29 de febrero, 1948, pp. 31-38; <<Talpa>>, núm. 62, 29 de febrero, 1948, pp. 79-87; <<El Llano en llamas>>, núm. 64, diciembre, 1950, pp. 66-85; y <<Diles que no me maten>>, núm. 66, agosto, 1951, pp. 125-130. Cfr. García Bonilla\index[nombres]{Garcia@García Bonilla, Roberto}, \emph{op. cit.}, pp. 411-412 y Acuña\index[nombres]{Acuna@Acuña González, Elvira}, \emph{op. cit.}, pp. 174-175.} Así, con el impulso de estas dos revistas, se iba perfilando y difundiendo, paulatinamente, el magistral libro de Rulfo\index[nombres]{Rulfo, Juan} antes de salir en su primera edición de 1953. Esto fue motivo de enemistad entre Rulfo y Marco Antonio Millán\index[nombres]{Millan@Millán, Marco Antonio}, Director de \emph{América}, dado que Rulfo había insinuado la posibilidad de que sus cuentos se publicaran todos, por primera vez, en la revista; finalmente, como se sabe, aparecieron bajo el sello del Fondo de Cultura Económica, en la colección Lecturas Mexicanas.
...
\pagestyle{empty}
\AddToShipoutPictureBG*{%
\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight]{eh2}} % \transparent{0.4}
}
\null\vfill
% CAPÍTULO 1
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
%\fancyhead[RE]{\small\sc el humor como poética en los cuentos de efrén hernández}
%\fancyhead[LO]{\small\sc i \textbullet\ risa, vanguardia y cuento hispanoamericano}
\fancyhead[CE]{\small\sc el humor como poética en los cuentos de efrén hernández} % Centrados
\fancyhead[CO]{\small\sc i \textbullet\ risa, vanguardia y cuento hispanoamericano} % Centrados
\fancyhead[RO,LE]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\pagenumbering{arabic}
\setcounter{page}{25}
...
\end{quoting}
En este nuevo imaginario social, que toma fuerza principalmente en el París\index[lugares]{Paris@París} de finales del \textsc{xix}, el escenario hasta entonces reconocido como propio de la actividad artística cambia. Como asienta Bolívar Echeverría, la figura del artista se desplaza de los talleres de arte institucionales a cafés y cabarets, en los que, como puede advertirse en \emph{Baile en el Moulin de la Galette} de Renoir, <<la vida se libera de su compulsión productivista>>\footnote{Bolívar Echeverría, <<De la academia a la bohemia y más allá>>. \emph{Theoría. Revista del Colegio de Filosofía} 19 (2009), p. 51.} y se acerca al mundo de la fiesta, lo cual simboliza la vuelta del arte a su matriz premoderna. A partir de este desplazamiento, el arte de vanguardia deja atrás la \emph{mímesis de la realidad} y se resuelve en una \emph{mímesis festiva}, que es
\begin{quoting}
...
La narrativa de Efrén Hernández ha sido ligada a la vanguardia iberoamericana\index[lugares]{Iberoamerica@Iberoamérica} de los años veinte y principios de los treinta. Esta tesis fue sugerida por John Brushwood, para quien Hernández es un escritor moderno porque <<va desde los experimentos de la época vanguardista hasta la reafirmación de las mismas tendencias en la nueva novela>>.\footnote{John Brushwood, <<Efrén Hernández y la innovación narrativa>>, \emph{Nuevo Texto Crítico}, \textsc{i}, (1988), p. 93.}
...
\begin{enumerate}[topsep=14pt,noitemsep] % Javier Bezos improvements.
...
\begin{quoting}
La esencia del cuento vanguardista radica en su estructura. El discurso transcurre por vías inusuales que obedecen más a los procesos de la mente que a los hechos concretos. \nota{Convertida a textual porque rebasó los 4 renglones, según la norma.} El principal interlocutor es el propio emisor del discurso, que encuentra en el monólogo interior la vía idónea de comunicación.\footnote{Franco, \emph{Voces...}, p. 46.}
\end{quoting}
Si Efrén Hernández es el paradigma de esta invasión, otro mexicano, César Garizurieta, tiene un estilo muy parecido, en el que el interior y el exterior forman un continuo determinado por la subjetividad, véase por ejemplo <<Pobre gato>>.\footnote{César Garizurieta, <<Pobre gato>>, en Franco, \emph{Voces...}, p. 416.}

En un estilo diferente, la importancia de los procesos mentales, el rol protagónico del \emph{yo}, también está presente en los cuentos del uruguayo Felisberto Hernández, como en <<El vapor>>, en el que puede apreciarse la \emph{invasión de la primera persona}: <<Y sin darme cuenta caí en la impersonalidad: parecía que todo el cuerpo se me hubiera salido por los ojos>>.\footnote{Felisberto Hernández, <<El vapor>>, en \emph{La cara de Ana}, 1939, Edición Dominio Público.}

Esta \emph{invasión de la primera persona} representa un desplazamiento del foco del relato del mundo exterior al mundo interior, a la subjetividad. El protagonismo de muchos de estos relatos recae por completo en esa interioridad fragmentada en un cúmulo de vivencias, al grado de que, según Franco: <<El cuento vanguardista carece de interacción; cuando en él hay un `Tú', este se deslíe hasta convertirse en una mera evocación, en un sustrato cuyo papel se limita a ser el detonante de los
procesos mentales del narrador>>.\footnote{Franco, \emph{Voces...}, p. 37.} Es el caso del ya mencionado <<Pobre gato>> de César Garizurieta, donde se presenta a un narrador fragmentario y discontinuo, lejano del confiable narrador de la cuentística anterior.
...
\pagestyle{empty}
\AddToShipoutPictureBG*{%
\AtPageLowerLeft{\includegraphics[width=\paperwidth,height=\paperheight]{eh3}} % \transparent{0.4}
}
\null\vfill
% BIBLIOGRAFÍA
...
\hangpara{1cm}{1}\textsc{Aira}, César, \emph{Diccionario de autores latinoamericanos}. Emecé"/Ada Korn, Buenos Aires, 2001, 634 pp.\phantomsection\label{bib:aira2001}
...
\hangpara{1cm}{1}\textsc{Amat}, Nuria, \emph{Juan Rulfo, el arte del silencio}. Omega, Barcelona, 2003, 118 pp.\phantomsection\label{bib:amat2003}

\hangpara{1cm}{1}\textsc{Bajtín}, Mijaíl, \emph{Teoría y estética de la novela. Trabajos de investigación} (trad. Helena Kriúkova y Vicente Cazcarra). Taurus, Madrid, 1989, 522 pp.\phantomsection\label{bib:bajtin1989}

\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{La cultura popular en la Edad Media y en el Renacimiento. El contexto de Fran"cois Rabelais} (trad. Julio Forcat y César Conroy). Alianza Universidad, Madrid, 1993, 432 pp.\phantomsection\label{bib:bajtin1993}

\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Problemas de la poética de Dostoievski} (trad. Tatiana Bubnova). Fondo de Cultura Económica, México, 2005, 399 pp.\phantomsection\label{bib:bajtin2005}

\hangpara{1cm}{1}\textsc{Baquero Goyanes}, Mariano, \emph{El cuento español en el siglo \textsc{xix}}. Consejo Superior de Investigaciones Científicas, Madrid, 1949, 706 pp.\phantomsection\label{bib:baquero1949}

\hangpara{1cm}{1}\textsc{Beltrán Almería}, Luis, \emph{La imaginación literaria. La seriedad y la risa en la literatura occidental}. Montesinos, Barcelona, 2002, 336 pp.\phantomsection\label{bib:beltran2002}
...
\hangpara{1cm}{1}\textsc{Berdeja Acevedo}, Juan Manuel, \emph{Efrén Hernández: El arte de la digresión en \emph{El Señor de Palo} y \emph{Cerrazón sobre Nicómaco}} (Dir.\,Rose Corral). El Colegio de México, México, 2016, 264 pp. [Tesis de Doctorado]. \phantomsection\label{bib:berdeja2016}
...
\hangpara{1cm}{1}\textsc{Burgos}, Fernando (ed., introd. y ns.), \emph{El cuento hispanoamericano en el siglo \textsc{xx}}. Castalia, Madrid, 1997, \hl{¿págs?}.\phantomsection\label{bib:burgos1997}

\hangpara{1cm}{1}\textsc{Calderón de la Barca}, Pedro, \emph{La vida es sueño} (est. prel. y ns. María Elba Foix). Kapelusz, \hl{¿Argentina?}, 7"a edición, 1964, \hl{¿págs?}.\phantomsection\label{bib:calderon1964}
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt}, <<Efrén Hernández, prosista ingenioso, poderoso y sustancioso>>. \emph{Unomásuno} (16 de marzo, 1985), México, \hl{¿págs?}.\phantomsection\label{bib:carballo1985}
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt}, <<La creación narrativa del Nuevo Mundo>>, en Fundación Juan March (\hl{13 al 12 de noviembre, 1992}).\phantomsection\label{bib:pupowalker1992}
...
\hangpara{1cm}{1}\textsc{Riva Palacio}, Vicente, \emph{Los cuentos del general}, Madrid, Sucesores de Rivadeneyra, 1896, \hl{¿págs?}\phantomsection\label{bib:rivapalacio1896}

\hangpara{1cm}{1}\textsc{Rodríguez Freyle}, Juan, \emph{El carnero}, Caracas, Fundación Biblioteca Ayacucho, 1979\hl{¿págs?}\phantomsection\label{bib:rodriguez1979}
...
\hangpara{1cm}{1}\textsc{Rosas Hernández}, Francisco Alfredo, \emph{Callada luz: un acercamiento a la obra de Efrén Hernández} (\hl{¿Dir.?}), México, Universidad del Claustro de Sor Juana, 2002, \hl{¿págs.?}, [Tesis de Licenciatura].\phantomsection\label{bib:rosas2002a}
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt}, <<El sueño de la mente acósmica>>, en \textsc{Toledo}, Alejandro (comp.), \emph{Dos escritores secretos. Ensayos sobre Efrén Hernández y Francisco Tario}, México, Consejo Nacional para la Cultura y las Artes"/Fondo Editorial Tierra Adentro, núm. 117-118, 2006, pp. 120-141.\phantomsection\label{bib:rosas2006}

\hangpara{1cm}{1}\textsc{Schiller}, Friedrich, \emph{Poesía ingenua y poesía sentimental} (est. prel. Robert Leroux), Buenos Aires, Nova, 1963, \hl{¿págs?}\phantomsection\label{bib:schiller1963}

\hangpara{1cm}{1}\textsc{Schwartz}, Jorge, \emph{Las vanguardias latinoamericanas}, México, Fondo de Cultura Económica, 2006, \hl{¿págs?}\phantomsection\label{bib:schwartz2006}

\hangpara{1cm}{1}\textsc{Sebold}, Russell P. \emph{Novela y autobiografía en la <<vida>> de Torres Villarroel}, Barcelona, Ariel, 1975, \hl{¿págs?}\phantomsection\label{bib:sebold1975}

\hangpara{1cm}{1}\textsc{Sheridan}, Guillermo, \emph{Monólogos en espiral. Antología de narrativa <<Homenaje Nacional a los \emph{Contemporáneos}>>} (intro., sel., y notas de Guillermo Sheridan), México, Instituto Nacional de Bellas Artes, 1982, \hl{¿págs?}\phantomsection\label{bib:sheridan1982}

% http://www.cervantesvirtual.com/ http://www.cervantesvirtual.com/nd/ark:/59851/bmcbr985
\hangpara{1cm}{1}\textsc{Sobejano}, Gonzalo, <<La digresión en la prosa narrativa de Lope de Vega y en su poesía epistolar>>, en \href{http://www.cervantesvirtual.com/}{\emph{Biblioteca Virtual Miguel de Cervantes}}, Alicante, 2009, \hl{¿págs?}. [En línea]: \url{http://www.cervantesvirtual.com/nd/ark:/59851/bmcbr985}\phantomsection\label{bib:sobejano2009}

\hangpara{1cm}{1}\textsc{Sterne}, Laurence, \emph{Vida y opiniones del caballero Tristram Shandy}, Madrid, Cátedra, 2007 (7"a edición), \hl{¿págs?}\phantomsection\label{bib:sterne2007}
...
\hangpara{1cm}{1}\textsc{Tzara}, Tristan, \emph{Siete manifiestos Dada}, México, Tusquets, 2013, \hl{¿págs?}\phantomsection\label{bib:tzara2013}
...
\hangpara{1cm}{1}\rule{1cm}{0.4pt}, \emph{Los cuentos de \emph{El cuento} \textsc{iii}, antologías temáticas: Ingenios del humorismo}, México, García Valadés, 1988, \hl{¿págs?}\phantomsection\label{bib:valades1988}
...
\hangpara{1cm}{1}\textsc{Vega}, Garcilaso de la, \emph{Poesía completa} (ed. Juan Francisco Alcina), Madrid, Austral, 1998 (5"a edición), \hl{¿págs?}\phantomsection\label{bib:vega1998}

\hangpara{1cm}{1}\textsc{Verani}, Hugo J. (ed.), \emph{Narrativa vanguardista hispanoamericana}, México, Universidad Nacional Autónoma de México, 1996, \hl{¿págs?}\phantomsection\label{bib:verani1996}

\hangpara{1cm}{1}\textsc{Villaurrutia}, Xavier, <<Efrén Hernández: El señor de palo>>, en \emph{Obras} (pról. de Alí Chumacero; recopilación de textos de Miguel Capistrán, Alí Chumacero y Luis Mario Schneider; bibliografía de Luis Mario Schneider), México, Fondo de Cultura Económica, 1996, \hl{¿págs?}\phantomsection\label{bib:villaurrutia1996}
...
\fancyhf{} % Remueve los encabezados y pies previos. Necesario sí o sí.
%\fancyhead[RE]{\small\sc el humor como poética en los cuentos de efrén hernández}
%\fancyhead[LO]{\small\sc índice onomástico}
\fancyhead[CE]{\small\sc el humor como poética en los cuentos de efrén hernández} % Centrados
...
\pagenumbering{arabic}
\setcounter{page}{47}
%\indexprologue{\noindent Se proporciona una lista detallada y en estricto orden alfabético de los principales nombres usados en este trabajo. Los números que aparecen después de las comas son los correspondientes a su página.}
\printindex[nombres]
% ÍNDICE TOPONÍMICO
\newpage
\thispagestyle{plain}
...
\end{center}
% H\`an Th\'{\^e} Th\`anh
{\scriptsize\squarepar{\emph{La trascendencia de lo nimio. El humor como poética en los cuentos de Efrén Hernández} de José Julián González Osorno, se terminó de componer en Universidad Autónoma de Nuevo León núm. 7305, col. Universidades, Heroica Puebla de Zaragoza (México). El manuscrito se capturó con el editor de texto plano \TeX{}maker (5.0.3) de Pascal Brachet, y se formó en el sistema de composición tipográfico \LaTeX{} de Leslie Lamport, basado en el lenguaje de programación \TeX{} creado por Donald E. Knuth; el archivo fuente fue compilado con el motor de tipografías pdf\TeX{} desarrollado por H\`an Th\'{\^e} Th\`anh. En su composición se empleó tipografía Cronos Pro\texttrademark{}, diseñada por Robert Slimbach en 1996 para Adobe\texttrademark{} Systems Incorporated. Las imágenes se manipularon en \textsc{gimp} (2.10.22); la portada se diseñó en LibreOffice Draw (7.3.3.2). Disposición tipográfica realizada para papel \emph{Bond} ahuesado tamaño carta de 90\,gr. Diseño, diagramación y composición tipográfica: \href{muxkernel@gmail.com}{Tuxkernel}.}}
%\begin{center}
%\includegraphics[width=1cm]{tug}
%\end{center}
\end{document}
